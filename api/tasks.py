                ...
                for row in csv_reader:
                    ...
                    try:
                        ...
                        if response.status_code == 200:
                            ...
                            experience.highlight_image.save(unique_filename, File(img_temp))
                            experience.save()
                        else:
                        ...
                        # if response.status_code == 200:
                        #     uploaded_image = ContentFile(response.content, name=unique_filename)
                        # else:
                        #     uploaded_image = None

                        # # Pass the downloaded image to the handler
                        # handler = AppContentFileHandler(
                        #     app_content=experience,
                        #     video=None,
                        #     image=uploaded_image,
                        #     thumb=None  # Assuming no thumbnail URL is provided
                        # )
